...
import 'package:fantasy_elrokn/screens/auth/sinup_screen.dart';
                    ...
                    isEmailEmpty || isPasswordEmpty
                        ...
                        : EnabledButtonWidget(
                            ...
                            onPressed: () async {
                              ...
                              await model.loginEmailPassword(
                              ...
                              if (model.userNotFound &&
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  snack(
                                      'User Not found', SharedColors.redTable),
                                );
                              } else if (model.userNotFound == false &&
                                  model.wrongPassword) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  snack(
                                      'Wrong Password', SharedColors.redTable),
                                );
                              } else if (model.userNotFound &&
                                  model.wrongPassword) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  snack(
                                      'User Not found', SharedColors.redTable),
                                ...
                                if (model.isGwFinished) {
                                  if (model.gw1CurrentG1) {
                                    ...
                                    model.allGroupOneTeams[0].matchesPlayed !=
                                            10
                                        ? await model.makingTableG1(
                                            gw: model.gw10G1,
                                            team1Index: 0,
                                ...
                                if (model.isGwFinished) {
                                  if (model.gw1CurrentG2) {
                                    ...
                                    model.allGroupTwoTeams[0].matchesPlayed !=
                                            10
                                        ? await model.makingTableG2(
                                            gw: model.gw10G2,
                                            team1Index: 4,
